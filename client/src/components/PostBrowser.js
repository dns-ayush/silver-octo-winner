  ...
  return (
    <>
      <Stack spacing={2}>
        ...
        <Card>
          <HorizontalStack justifyContent="space-between">
            <p><b style={{color: "#1976D2"}}>About:</b> Demand & Service allows users to raise their demands for local services and needs on
             this platform. We provide this information to business opportunists so they can set up their business in demanded regions to grow exponentially.
             <br></br>
             <br></br>
             <b style={{color: "#1976D2"}}>Manual: </b><li>A user can raise his local demand by just clicking on "Raise New Demand"</li>
             <li>Business Opportunists can simply see "Top Demands in Area" for business opportunities</li>
             <li>Business Opportunists can also filter demands according to their needs for business opportunities</li>
            </p>
          </HorizontalStack>
        </Card>
